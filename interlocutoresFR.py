...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master = master
        self.master.title("Carta de interlocutores FRANCÉS")
...
###################### idea para sacar todos los datos necesarios del excel ###################################################################
        ...
        if checkbox_values[0]:
            template = f"C:\\Users\\{username}\\Incye\\Ingenieria - Documentos\\12_Aplicaciones\\interlocutores\\ci_montajefr.docx"
        if checkbox_values[1]:
            template = f"C:\\Users\\{username}\\Incye\\Ingenieria - Documentos\\12_Aplicaciones\\interlocutores\\ci_sinmontajefr.docx"
        ...
        mail.Body = f"Cher client. \n\nVeuillez trouver ci-joint une lettre des interlocuteurs avec les coordonnées du personnel INCYE impliqué dans le travail. \n\nMeilleures salutations. \n\n{tecnico} - Dpto. de Ingeniería INCYE "
