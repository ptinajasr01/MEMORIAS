...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.master = master
        self.master.title("Nota de Calculo de APEO (FRANCIA)")
    ...
    def fill_template(self):
        ...
        template = "C:/Memorias y servidor/Apeos/23A-----M_Nota_de_calculo_23----fr.docx"
        ...
        if checkbox_values[0]:   # Alshor Plus
            document.merge(AL="Le système Alshor Plus est un système d’étaiement en aluminium d’une capacité de charge allant jusqu’à 120 kN par pied, composé de vérins réglables, de verticales, de cadres et de bols. Avec le système Alshor Plus, les poutres Albeam seront utilisées comme poutres de distribution.")
        if checkbox_values[1]:  # Shoring 75
            document.merge(SH="Le système Kwikstage Shoring 75 est un système d'étaiement en acier d'une capacité de charge allant jusqu'à 75 kN, composé de fourches réglables, verticales, ténon, horizontales et réglables. Avec le système Kwikstage Shoring 75, les poutres Superslim seront utilisées comme poutres de distribution.")
        ...
        if checkbox_values[0] and not checkbox_values[1] and not checkbox_values[2] and not checkbox_values[3]:      
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1001
        if checkbox_values[0] and not checkbox_values[1] and not checkbox_values[2] and checkbox_values[3]:    
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans les valeurs Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1010
        if checkbox_values[0] and not checkbox_values[1] and checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du Superslim, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1011
        if checkbox_values[0] and not checkbox_values[1] and checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du Superslim et du Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1100
        if checkbox_values[0] and checkbox_values[1] and not checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du KS, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1101
        if checkbox_values[0] and checkbox_values[1] and not checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du KS et du Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1110
        if checkbox_values[0] and checkbox_values[1] and checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du KS et du Superslim, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 1111
        if checkbox_values[0] and checkbox_values[1] and checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Alshor, ainsi que dans celle du Superslim, du KS et du Megaprop, les valeurs incluses dans les graphiques sont des valeurs en état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0001
        if not checkbox_values[0] and not checkbox_values[1] and not checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0010
        if not checkbox_values[0] and not checkbox_values[1] and checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Superslim, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0011
        if not checkbox_values[0] and not checkbox_values[1] and checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système Superslim, ainsi que dans celle du Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’elles sont des valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0100
        if not checkbox_values[0] and checkbox_values[1] and not checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système KS, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0101
        if not checkbox_values[0] and checkbox_values[1] and not checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système KS, ainsi que dans celle du mégaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0110
        if not checkbox_values[0] and checkbox_values[1] and checkbox_values[2] and not checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système KS, ainsi que dans celle du Superslim, les valeurs incluses dans les graphiques sont des valeurs dans l’état limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")
        # 0111
        if not checkbox_values[0] and checkbox_values[1] and checkbox_values[2] and checkbox_values[3]:
            document.merge(SST="Remarque: Dans la fiche technique du système KS, ainsi que dans celle du Superslim et du Megaprop, les valeurs incluses dans les graphiques sont des valeurs dans l’état de limite de service, c’est-à-dire qu’il s’agit de valeurs déjà réduites d’un coefficient de 1,50. Pour comparer avec des charges plus élevées, il est nécessaire de multiplier les valeurs admissibles des graphiques par 1,50 afin de ne pas prendre en compte un facteur plus élevé doublé.")

        # Ruta de guardado
        doc_modified = "C:/Memorias y servidor/Apeos/Plantilla_apeosfr.docx"
        document.write(doc_modified)
        
        if __name__ == '__main__':
            document_path = 'C:/Memorias y servidor/Apeos/Plantilla_apeosfr.docx'

            # texto para meter pdfs
            texto_apendice = "ET MATÉRIAUX MÉCANIQUES INCYE"
            ...
            texto_AL = "Le système Alshor Plus est un système d’étaiement en aluminium d’une capacité de charge allant jusqu’à 120 kN par pied, composé de vérins réglables, de verticales, de cadres et de bols. Avec le système Alshor Plus, les poutres Albeam seront utilisées comme poutres de distribution."
            imagen_AL = "C:/Memorias y servidor/Apeos/Imagenes/alshor.png"


            # texto e imagenes del Shoring 75
            texto_SH = "Le système Kwikstage Shoring 75 est un système d'étaiement en acier d'une capacité de charge allant jusqu'à 75 kN, composé de fourches réglables, verticales, ténon, horizontales et réglables. Avec le système Kwikstage Shoring 75, les poutres Superslim seront utilisées comme poutres de distribution."
